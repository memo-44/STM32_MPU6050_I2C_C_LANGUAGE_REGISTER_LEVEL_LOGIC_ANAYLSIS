...
/** @addtogroup STM32F4xx_System_Private_Variables
  ...
  */
  ...
  uint32_t SystemCoreClock;//************168 BÝNE EÞÝT OLACAK AMA BÝZ YAPMIYORUZ
...
void SystemInit(void)
{
  ...
  //SetSysClock();/********SÝMDÝLÝK DURSUN,BURADA BU ÝÞLEM GERÇEKLEÞÝRSE CÝHAZ
  //**********************KENDÝNÝ 168 MHZ KÝTLÝYOR VE ÝSTEDÝÐÝMÝZ SAAT FREKANSINI
  //**********************AYARLAYAMIYORUZ*****/
